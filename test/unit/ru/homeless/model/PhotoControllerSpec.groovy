...
class PhotoControllerSpec extends Specification {
    ...
    void "Test the create action returns the correct model"() {
        ...
        then: "The security is correctly created"
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        then: "The create view is rendered again with the correct security"
        model.photoInstance != null
        view == 'create'
    ...
    void "Test that the show action returns the correct model"() {
        ...
        then: "A security is populated containing the domain instance"
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        response.redirectedUrl == "/photos/show/$photo.id"
        flash.message != null
    }
