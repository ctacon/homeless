modules = {
    ...
    fileupload{
        resource url: 'jQuery-File-Upload-9.5.0/js/vendor/jquery.ui.widget.js'
        resource url: 'jQuery-File-Upload-9.5.0/js/jquery.iframe-transport.js'
        resource url: 'jQuery-File-Upload-9.5.0/js/jquery.fileupload.js'
        resource url: 'jQuery-File-Upload-9.5.0/js/jquery.fileupload-process.js'
        resource url: 'jQuery-File-Upload-9.5.0/js/jquery.fileupload-image.js'
    }
