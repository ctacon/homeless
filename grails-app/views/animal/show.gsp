...
<section id="show-animal" class="first">
    ...
    <table class="table">
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value"><g:link controller="animalCharacter" action="show"
                                                   id="${animalInstance?.character?.id}">${animalInstance?.character?.encodeAsHTML()}</g:link></td>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value"><g:link controller="photo" action="show"
                                                   id="${animalInstance?.avatar?.id}">${animalInstance?.avatar?.encodeAsHTML()}</g:link></td>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value"><g:link controller="animalSex" action="show"
                                                   id="${animalInstance?.sex?.id}">${animalInstance?.sex?.encodeAsHTML()}</g:link></td>
