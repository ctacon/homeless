    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <g:sortableColumn property="fileSize"
                              title="${message(code: 'photos.fileSize.label', default: 'File Size')}"/>

            <g:sortableColumn property="newFilename"
                              title="${message(code: 'photos.newFilename.label', default: 'New Filename')}"/>

            <g:sortableColumn property="originalFilename"
                              title="${message(code: 'photos.originalFilename.label', default: 'Original Filename')}"/>
        ...
        <g:each in="${photoInstanceList}" status="i" var="photoInstance">
            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                ...
                <td><g:link action="show"
                            id="${photoInstance.id}">${fieldValue(bean: photoInstance, field: "fileSize")}</g:link></td>
