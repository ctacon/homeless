...
<section id="intro" class="first">
    ...
    <p>
        «БЕЗДОМЫШИ» - это сеть передержек в квартирах и домах наших волонтеров.

        Передержка – временный дом для бездомных животных, здесь происходит их реабилитация и лечение после суровой уличной жизни.

        Сегодня на нашем попечении более 200 подопечных, кошки и собаки, от маленьких малышей до взрослых животных!

        Все они однажды пострадали от рук и равнодушия человека, и теперь наша общая задача, подарить им новый шанс на счастливую жизнь! Показать что мир не так жесток, есть те, кто протянет руку помощи в трудную минуту. Ведь добро…начинается с малого)

        Мы всегда рады новым участникам и волонтерам в нашей команде! И спасибо тем, кто уже с нами!
    </p>
    <g:link class="btn btn-large btn-primary" controller="nextSteps">Как помочь?</g:link>
</section>
