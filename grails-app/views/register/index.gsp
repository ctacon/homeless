                    ...
                    <g:else>
                        <fieldset class="form">
                            ...
                            <div class="control-group fieldcontain ${hasErrors(bean: command, field: 'password2', 'error')} ">
                                <label for='password2' class="control-label" ><g:message code="user.password2.label"/>:</label>
                                <div class="controls">
                        ...
                        <div class="controls">
                            <input type='submit' id="submit" class="btn btn-success" value='${message(code: "spring.security.ui.register.submit")}'/>
                        </div>
                    </g:else>
