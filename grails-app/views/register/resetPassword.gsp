...
<section id="resetSelection" class="first">
    <div class="row">
        ...
        <div class="span6">
            ...
            <form id='resetPasswordForm' class='form-horizontal' action='resetPassword' method='POST'
                  autocomplete='off'>
                ...
                <fieldset class="form">
                    <div class="control-group fieldcontain ${hasErrors(bean: command, field: 'password', 'error')} ">
                        <label for='password' class="control-label"><g:message
                                code="resetPasswordCommand.password.label"/>:</label>
                    ...
                    <div class="control-group fieldcontain ${hasErrors(bean: command, field: 'password2', 'error')} ">
                        <label for='password' class="control-label"><g:message
                                code="resetPasswordCommand.password2.label"/>:</label>
                ...
                <div class="controls">
                    <input type='submit' id="reset" class="btn btn-success"
